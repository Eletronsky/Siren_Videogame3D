...
public class EnemyAIBasic : MonoBehaviour
{
    ...
    public Vector3 walkPoint; //Dirección hacia la que se moverá la IA si no detecta al target.
    ...
    public float timeBetweenAttacks; //Tiempo de espera entre ataque y ataque (Se puede igualar a la duración de la animación de ataque).
    ...
    void SearchWalkPoint()
    {
        ...
        {
            walkPointSet = true; //Confirmamos que el punto es caminable, por lo que empezará el movimento.
        }
    }
    ...
    //Función para que los Gizmos de detección (perseguir/ataque) se dibujan en escena al seleccionar el objeto.
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        //Dibuja una esfera de color amarillo que deifne el rango de persecución.
